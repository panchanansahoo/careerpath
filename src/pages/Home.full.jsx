...
export default function Home() {
  ...
  return (
    <div>
      ...
      <div style={{ background: 'red', color: 'white', fontSize: '40px', padding: '60px', textAlign: 'center', fontFamily: 'Arial, sans-serif', fontWeight: 'bold', zIndex: 9999, position: 'relative' }}>
      ...
      <section className="home-cta-banner">
        <div className="container">
          <h2>Ready to Ace Your Tech Interview with AI-Powered Preparation?</h2>
          <p>
            Join 15k+ engineers who transformed their careers with CareerPath's comprehensive platform:
            DSA patterns, AI interviews, system design practice, resume optimization, and personalized coaching. Start your journey today.
          </p>
          <div className="hero-buttons">
            <Link to="/signup" className="btn-hero-primary" style={{ display: 'inline-flex' }}>
              Get Started Free <ArrowRight size={18} />
            </Link>
            <Link to="/signup" className="btn-hero-outline" style={{ display: 'inline-flex' }}>
              Start Free
            </Link>
          </div>
        </div>
          ...
          <div className="roadmap-grid">
            <div className="roadmap-card">
              ...
              <p className="roadmap-sub">
                Structured learning path covering DSA patterns, system design, and interview preparation
              </p>
            ...
            <div className="roadmap-card">
              <h3>90-Day AI & ML Roadmap</h3>
              <p className="roadmap-sub">
                Complete path from Data Science fundamentals to GenAI and LLM mastery
              </p>
              <ul className="feature-list" style={{ marginBottom: 20 }}>
              ...
              <Link to="/dashboard/learning-path/data-science" className="btn-pricing outline" style={{ marginTop: 16 }}>
                View Roadmap
              </Link>
            </div>
          </div>
          <p style={{ textAlign: 'center', color: 'var(--text-muted)', marginTop: 20, fontSize: 14 }}>All future roadmap updates included</p>
        </div>
      </section>
      ...
      <section className="home-section" id="blog">
        <div className="container">
          <div className="section-header">
            <h2>Expert Guides: DSA Patterns, Interview Practice & Resume Optimization</h2>
            <p>Learn from our comprehensive guides on mastering technical interviews, DSA patterns, and career advancement strategies</p>
          </div>
          ...
          <div style={{ textAlign: 'center', marginTop: 24 }}>
            <Link to="/blog" style={{ color: 'var(--accent)', textDecoration: 'none', fontSize: 14, fontWeight: 600, display: 'inline-flex', alignItems: 'center', gap: 6 }}>
      ...
      <section className="home-section alt-bg" id="faq">
        <div className="container">
          <div className="section-header">
            <h2>FAQ: DSA Patterns, AI Interviews, System Design & Learning Tracks</h2>
            <p>Everything you need to know about our DSA patterns sheet, AI-powered mock interviews, system design preparation, resume analysis, learning tracks for PM/Data Science/AI, and AI code practice</p>
          </div>
      ...
      <section className="community-section">
        ...
        <p>Connect with thousands of engineers, share experiences, get help, and stay updated with the latest interview trends and tips.</p>
        <div className="hero-buttons">
          <a href="https://discord.gg/zxywjSuvDT" target="_blank" rel="noopener noreferrer" className="btn-discord">
            <Users size={20} /> Join Discord Community
          </a>
          <a href="https://discord.gg/zxywjSuvDT" target="_blank" rel="noopener noreferrer" className="btn-hero-outline" style={{ display: 'inline-flex' }}>
            Join Discord
          </a>
        </div>
      </section>
